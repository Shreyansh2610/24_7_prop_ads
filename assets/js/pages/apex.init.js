...
var colors = ["#3bc0c3", "#47ad77", "#fa5c7c", "#39afd1"],
    ...
    optionsCandlestick =
            ...
            (colors = dataColors.split(",")),
        {
            ...
            plotOptions: {
                candlestick: {
                    colors: { upward: colors[0], downward: colors[1] },
                },
            },
            xaxis: { type: "datetime" },
            grid: { borderColor: "#f1f3fa" },
    ...
    options = {
        ...
        series: [
            { name: "Desktops", data: [40, 35, 55, 60, 33, 70, 80, 96, 130] },
        ],
        ...
        series: [
            {
                ...
                type: "column",
                data: [
                    500, 510, 420, 680, 400, 415, 340, 360, 780, 340, 270, 180,
                ],
            },
            {
                name: "Social Media",
